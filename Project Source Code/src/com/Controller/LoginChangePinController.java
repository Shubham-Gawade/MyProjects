...
/**
 * Servlet implementation class LoginChangePinController
 */
@WebServlet("/LoginChangePinController")
public class LoginChangePinController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginChangePinController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			response.sendRedirect("EnterLogin3.jsp");
		}
	}
