...
/**
 * Servlet implementation class LoginPinController
 */
@WebServlet("/LoginPinController")
public class LoginPinController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginPinController() {
        super();
