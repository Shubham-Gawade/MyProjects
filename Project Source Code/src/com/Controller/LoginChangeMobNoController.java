...
/**
 * Servlet implementation class LoginChangeMobNoController
 */
@WebServlet("/LoginChangeMobNoController")
public class LoginChangeMobNoController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginChangeMobNoController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			response.sendRedirect("EnterLogin4.jsp");
		}
	}
