...
/**
 * Servlet implementation class LoginPassController
 */
@WebServlet("/LoginPassController")
public class LoginPassController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoginPassController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			response.sendRedirect("EnterLogin2.jsp");
		}
	}
